...
// Portfolio data for carousel
        ...
        // Skills data
        const skillsData = [
            { name: 'Shopify', icon: '<i class="fa-brands fa-shopify"></i>', level: 95, category: 'frontend' },
           
            { name: 'Wordpress', icon: '<i class="fa-brands fa-wordpress"></i>', level: 90, category: 'frontend' },
            { name: 'Webflow', icon: '<i class="fa-brands fa-webflow"></i>', level: 90, category: 'cloud' },
            { name: 'Git', icon: '<i class="fa-brands fa-git-alt"></i>', level: 75, category: 'cloud' },
            { name: 'Github', icon: '<i class="fa-brands fa-square-github"></i>', level: 80, category: 'backend' },
            { name: 'Javascript', icon: '<i class="fa-brands fa-js"></i>', level: 82, category: 'cloud' },
            { name: 'Boostrap', icon: '<i class="fa-brands fa-bootstrap"></i>', level: 90, category: 'backend' },
            { name: 'Node.js', icon: '<i class="fa-brands fa-node-js"></i>', level: 50, category: 'backend' },
            { name: 'Figma', icon: '<i class="fa-brands fa-figma"></i>', level: 68, category: 'emerging' },
            { name: 'React', icon: '<i class="fa-brands fa-react"></i>', level: 75, category: 'emerging' },
            { name: 'HTML', icon: '<i class="fa-brands fa-html5"></i>', level: 95, category: 'frontend' },
            { name: 'CSS', icon: '<i class="fa-brands fa-css3"></i>', level: 90, category: 'backend' }
        ];
        ...
        function createCarouselItem(data, index) {
            ...
            item.innerHTML = `
                <div class="card">
                    ...
                    <button class="card-cta" onclick="openProject('${data.url}')">Check</button>
                </div>
            `;
